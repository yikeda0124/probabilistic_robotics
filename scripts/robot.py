...
class Robot(IdealRobot):
    def __init__(self, pose, sensor=None, agent=None, color='black',
        ...
        super().__init__(pose, sensor, agent, color)
...
class Camera(IdealCamera):
    ...
    def __init__(self, env_map,
        ...
        self.distance_bias_rate_std = 1+norm.rvs(scale=distance_bias_rate_stddev)
    ...
    def bias(self, relpos):
        ell = relpos[0]*self.distance_bias_rate_std
...
if __name__ == '__main__':
    ...
    r = Robot(np.array([0,0,0]).T, sensor=Camera(m), agent=cicling)
    world.append(r)
